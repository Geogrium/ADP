...
def module2_online_rls_policy_iteration(env: VrabieLewisEnv, K_init, K_star):
    ...
    for i in range(1, 11):
        ...
        for _ in range(500):
            ...
            # 【修正点1】: 严格使用局部线性化动力学，保证纯二次型基底有解，完美等价 LQR
    ...
    for i in range(10):
        ...
        for _ in range(400):
            ...
            with torch.no_grad():
                ...
                # 【修正点3】: 使用正在更新的网络进行自举，阻断梯度，回归真正的 PI
